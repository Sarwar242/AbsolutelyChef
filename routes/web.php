...
Route::group(['prefix' => 'cart'], function () {
    ...
    Route::get('pay/{nonce}/{idempotency_key}/{token}', 'CartController@payment')->name('cart.payment');
});
...
Route::get('premium/pay/{nonce}/{idempotency_key}/{token}/{general}/{management}/{total_pay}', 'PaymentController@paypremium')->name('premium.pay');
//Dashboard Route
Route::group(['prefix'=>'dashboard', 'middleware' => 'dashboard'], function(){
    ...
    Route::get('/buypremium', 'DashboardController@buypremium')->name('buypremium');
...
Route::get('/success2', 'UserController@success2')->name('success2');
...
Route::get('invoice/paid/{payment}', 'UserController@invoice')->name('invoice');

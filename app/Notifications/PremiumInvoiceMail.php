...
class PremiumInvoiceMail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                        ->subject('Absolutely Chef Premium Balance and Invoice Payment Confirmation')
                        ->greeting('Dear '.ucwords($notifiable->name).',')
                        ->line('This is a notice that we have received your payment and an invoice has been generated and paid on '.$this->payment->created_at->format('d/m/Y').'.')
                        ...
                        ->line('Invoice Items:')
                        ->line('General Premium Job Balance:   '.$this->payment->general.' * 30')
                        ->line('Management Premium Job Balance: '.$this->payment->management.' * 50')
                        ->line('-----------------------------------------------------------------------------')
